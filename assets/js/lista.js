...
function atualizarlista() {
    ...
    <div id=b1>
    <button id="botao"type="button" onclick="deletar(${i})"><img id="fotinhaLixinho"src=https://cdn-icons-png.flaticon.com/512/126/126468.png width="18px" height="20px"></button>
    </div>
    </li>
    `
