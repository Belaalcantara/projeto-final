try {
	...
	(function(win, document) {
		...
		var last_release_ts = "2023-03-21 10:16:43";  // Last time a file was released from split test
		...
		// List of rtp files
		var rtp_files = {"21089":"latest","21090":"latest"};

		// List of custom tags
		var rtp_default_tags = {"Flex":["21089"],"Main":["21090"]};

		// Traffic Percentages
		var traffic_percentages = {"21089":0,"21090":1};
...
window.properSpecialOps = window.properSpecialOps || {};
window.properSpecialOps.country='BR';
window.properSpecialOps.region='SP';
